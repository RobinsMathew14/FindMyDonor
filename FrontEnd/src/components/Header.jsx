          ...
          <nav className="morph-menu">
            ...
            <div className="dropdown">
              ...
              <div className="dropdown-content">
                ...
                <Link to="/donor-form">Donor Registration</Link>
              </div>
            </div>
              ...
              <div className="user-menu-container">
                ...
                >
                  ...
                  <div className="user-info">
                    ...
                    <span className="user-type">{user.userType || 'Donor'}</span>
                  </div>
                  <div className="dropdown-arrow">
                    <svg 
                      ...
                      className={`arrow-icon ${showUserMenu ? 'rotated' : ''}`}
                    >
                  ...
                  <div className="user-menu">
                    <div className="user-menu-header">
                      <div className="user-menu-avatar">
                        {user.avatar ? (
                          <img src={user.avatar} alt="User Avatar" className="menu-avatar-img" />
                        ) : (
                          <span className="menu-avatar-initials">{getUserInitials()}</span>
                        )}
                      </div>
                    ...
                    <div className="user-menu-items">
                      ...
                      <Link to="/my-donations" className="user-menu-item" onClick={() => setShowUserMenu(false)}>
                        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
